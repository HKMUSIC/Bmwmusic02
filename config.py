...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/hkmusic/Bmwmusic02",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHAT", "https://t.me/NEW_Group_AVATAR_Society")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/NEW_Group_AVATAR_Society")

# Set this to True if you want the assistant to automatically leave chats after an interval
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", False))

# make your bots privacy from telegra.ph and put your url here 
PRIVACY_LINK = getenv("PRIVACY_LINK", "https://files.catbox.moe/p8qnbn.jpg")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/p8qnbn.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://files.catbox.moe/j596rd.jpg"
)
PLAYLIST_IMG_URL = "https://files.catbox.moe/nzl4fx.mp4"
STATS_IMG_URL = "https://files.catbox.moe/44jxny.jpg"
